    ...
    def __init__(self, ID):
        ...
        if (result):
            ...
            b2 = Button(self.root, text="Deposit", font="Times 20 bold", bd=10, width=15, height=1,
                        ...
                        command=lambda: self.deposit(ID))
            b2.grid(row=3, column=0)
            b3 = Button(self.root, text="Withdraw", font="Times 20 bold", bd=10, width=15, height=1,
                        justify="right", relief='ridge', bg="green", activebackground="blue",
                        command=lambda: self.withdraw(ID))
            b3.grid(row=3, column=1)
            self.root.mainloop()

        else:
            l1 = Label(self.root, text="You have entered wrong A/C_NO ", bd=1, width=30, padx=10,
            ...
            b2 = Button(self.root, text="Register", font="Times 20 bold", bd=15, width=13, height=1,
                        justify="right", relief='ridge', bg="blue", activebackground="blue",
