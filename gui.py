...
class Mainroot():
    def __init__(self):
        ...
        l1 = Label(self.root, text="Enter the Account No  ", bd=1, width=20,
        ...
        l1 = Label(self.root, text="Don't have any Account", bd=1, width=20,
    ...
    def check1(self):
        ...
        if (x1):
            ...
            tkinter.messagebox.showinfo("Error", "Please Enter a Account No")
